...
enum types {
  ...
  ITEM_LIMIT_ACTIVITY_GRAVEN_INNOCENCE = 3000,
  ITEM_LIMIT_ACTIVITY_GRAVEN_INNOCENCE_AVATAR_REWARD = 3001,
  ITEM_LIMIT_WOOD_EXCHANGE = 3002,
  ITEM_LIMIT_ACTIVITY_INSTABLE_SPRAY = 3003,
  ITEM_LIMIT_ACTIVITY_TREASURE_SEELIE = 3004,
  ITEM_LIMIT_ACTIVITY_MUQADAS = 3005,
  ITEM_LIMIT_ACTIVITY_ROCK_BOARD_EXPLORE = 3100,
  ITEM_LIMIT_ACTIVITY_WIND_FIELD = 3101,
  ITEM_LIMIT_ACTIVITY_VINTAGE = 3102,
  ITEM_LIMIT_ACTIVITY_FUNGUS_FIGHTER = 3201,
  ITEM_LIMIT_ACTIVITY_FUNGUS_FIGHTER_AVATAR_REWARD = 3202,
  ITEM_LIMIT_ACTIVITY_CHAR_AMUSEMENT = 3203,
  ITEM_LIMIT_ACTIVITY_EFFIGY_CHALLENGE_V2 = 3204,
  ITEM_LIMIT_ACTIVITY_BRICK_BREAKER = 3300,
  ITEM_LIMIT_AVATAR_RENAME = 3301,
  ITEM_LIMIT_GCG_LEVEL_REWARD = 3302,
  ITEM_LIMIT_GCG_CHALLENGE_REWARD = 3303,
  ITEM_LIMIT_GCG_REPEATABLE_CHALLENGE_REWARD = 3304,
  ITEM_LIMIT_ACTIVITY_COIN_COLLECT = 3305,
  ITEM_LIMIT_GCG_PROFICIENCY_REWARD = 3306,
  ITEM_LIMIT_ACTIVITY_SEA_LAMP_V3 = 3400,
  ITEM_LIMIT_ACTIVITY_SEA_LAMP_V3_AVATAR_REWARD = 3401,
  ITEM_LIMIT_COMPOUND_DROP = 3402,
  ITEM_LIMIT_ACTIVITY_ELECTROHERCULES_BATTLE = 3403,
  ITEM_LIMIT_ACTIVITY_TEAM_CHAIN = 3404,
  ITEM_LIMIT_ACTIVITY_GCG_FESTIVAL = 3405,
  ITEM_LIMIT_ACTIVITY_DUEL_HEART = 3406,
  ITEM_LIMIT_ACTIVITY_FLEURFAIR_V2 = 3500,
  ITEM_LIMIT_ACTIVITY_FUNGUS_FIGHTER_V2 = 3501,
  ITEM_LIMIT_ACTIVITY_AKA_FES = 3600,
  ITEM_LIMIT_ACTIVITY_AKA_FES_AVATAR_REWARD = 3601,
  ITEM_LIMIT_OFFERING_PARI_LEVEL = 3602,
  ITEM_LIMIT_ACTIVITY_SORUSH_TRIAL = 3603,
  ITEM_LIMIT_ACTIVITY_SANDWORM_CANNON = 3604,
}
